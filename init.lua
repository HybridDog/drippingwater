...
minetest.register_abm(
	...
	neighbors = {"group:water"},
		...
		minetest.add_entity({x=pos.x + i, y=pos.y - 0.5, z=pos.z + i}, "drippingwater:drop_water")
		end
        end,
})
...
minetest.register_abm(
	...
	neighbors = {"group:lava"},
		...
		minetest.get_node({x=pos.x, y=pos.y -2, z=pos.z}).name == "air" then
		local i = math.random(-45,45) / 100
		minetest.add_entity({x=pos.x + i, y=pos.y - 0.5, z=pos.z + i}, "drippingwater:drop_lava")
		end
        end,
})
